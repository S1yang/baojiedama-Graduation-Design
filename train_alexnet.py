...
parser.add_argument("--output_dir", default='./models/mlzsh-36b-nus-unseen-50d-top3/', help="where to put output files")
parser.add_argument("--log", default='./log/mlzsh-36b-nus-unseen-top3-50d-log.txt')
